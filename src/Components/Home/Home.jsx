...
function Home() {
  ...
  return (
    <>
      ...
      >
        <div className="pt-20 px-4 sm:px-10 lg:px-20 text-center max-w-5xl ">
          <span
            data-aos="fade-right"
            data-aos-offset="300"
          ...
          >
            ...
            <h1 className="text-black font-bold text-3xl sm:text-5xl md:text-6xl lg:text-7xl leading-snug sm:leading-tight mt-2">
              Quality Digital <br />
          ...
          <p className="text-center my-4 text-sm sm:text-base md:text-lg px-2 sm:px-0">
      ...
      <section className="my-12 sm:my-20">
        <div className="container mx-auto px-4 sm:px-10  lg:px-20 grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
          <div
            className="relative w-full flex justify-center md:justify-start"
            data-aos="zoom-in"
          >
            <img
              className="w-72 sm:w-80 md:w-3/4 rounded-2xl shadow-lg"
            ...
            />
            <img
              className="w-72 sm:w-80 md:w-3/4 rounded-2xl shadow-lg absolute top-12 left-12 md:top-20 md:left-20"
          ...
          <div className="text-center md:text-left" data-aos="zoom-in-up">
            <h2 className="text-blue-700 font-bold text-lg sm:text-xl">
              About Us
            </h2>
        ...
        <div className="container mx-auto px-4 sm:px-10 lg:px-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-10">
            {services.map((item) => (
              <div
                key={item.id}
                className="relative group shadow-lg shadow-gray-300 rounded-2xl overflow-hidden text-center p-6"
                data-aos="zoom-in"
              >
                ...
                <img
                  className="w-24 h-24 sm:w-28 sm:h-28 mx-auto relative z-10"
                  src={item.image}
                  alt={item.title}
                />

                <p className="font-bold py-3 text-lg sm:text-xl relative z-10">
                  {item.title}
                </p>

                <p className="text-gray-600 relative z-10 group-hover:text-white text-sm sm:text-base">
                  {item.description}
                </p>

                <button className="my-3 rounded-full bg-blue-700 py-2 px-4 relative z-10 text-sm sm:text-base">
                  {item.buttonText}
                </button>
              </div>
            ))}
      ...
      <section className="my-30">
        <div className="container mx-auto">
          ...
          <div className=" flex flex-col md:flex-row justify-center  mx-20 mt-20 gap-20">
            <div className="relative group inline-block" data-aos="zoom-in">
              <span className="relative ">
                ...
                />
                <div
                  className="w-30 h-12 bg-blue-600 text-white rounded-md top-10 left-10 absolute md:top-20 md:left-22 
      opacity-0 scale-95
      ...
      transition-all duration-300 z-10"
            ...
            <div className="relative group inline-block" data-aos="zoom-in">
              <span className="relative ">
                ...
                />
                <div
                  className="w-30 h-12 bg-blue-600 text-white rounded-md absolute top-10 left-10 md:top-20 md:left-22 
      opacity-0 scale-95
      group-hover:opacity-100 group-hover:scale-120
      transition-all duration-300 z-10"
                >
      ...
      <section>
        <div className="container mx-auto">
          ...
          <div className="mt-20 flex flex-col md:flex-row items-center justify-center gap-15 mx-20">
            <div
              className="shadow-lg shadow-gray-500  w-80 relative "
              data-aos="zoom-out-right"
            >
              <img
                className="w-80"
                src="https://media.istockphoto.com/id/1479759169/photo/data-science-and-big-data-technology-data-scientist-computing-analysing-and-visualizing.jpg?s=612x612&w=0&k=20&c=m5CzwqrVWCfTfYE7klKKth7CJ98uy0CBEiQGIKp-_X0="
                alt=""
              />
              ...
              <img
                className="w-20 object-cover rounded-full border-2 border-white outline-2 outline-white shadow-lg absolute top-45 left-30"
                src="https://www.uclawsf.edu/wp-content/uploads/2024/01/martin_d_cropped_low_res_transparent_19779.png"
                alt=""
              />
              <button className="rounded-full bg-green-400 px-4 py-2 absolute top-35  text-white">
                Read More
              </button>

              <span className="absolute top-35 right-4  ">
                <button className="rounded-full bg-green-400 px-5 py-2  relative group inline-block  overflow-hidden">
                  {" "}
                  <span className=" flex  items-center gap-3 text-white  group-hover:opacity-0">
                    Share <FaArrowRight />
                  </span>
